...
class MultiHeadAttention:
    ...
    def _merge_masks(self, key_padding_mask, attn_mask):
        ...
        key_mask = np.broadcast_to(key_padding_mask[:, None, None, :], (N, H, L, S))
        
        # Expand attn_mask to (1, 1, L, S) and broadcast to (N, H, L, S)
        attention_mask = attention_mask = np.broadcast_to(attn_mask[None, None, :, :], (N, H, L, S))
    ...
    def _split_heads(self, x):
        ...
        x = x.reshape(N, L_or_S, self.num_heads, self.embed_dim // self.num_heads)
